...
Future<Map> fetchMarvelCharacters() async {
  const publicKey = 'de16ee3bc274fbd07ccbc32b168ecd87';
  const privateKey = 'c146823faa9a4b3d972f29e305e37d015cc08a00';
  ...
  final response = await http.get(
    Uri.parse(
        'https://gateway.marvel.com/v1/public/characters?ts=$timestamp&apikey=de16ee3bc274fbd07ccbc32b168ecd87&hash=$hash'),
  );
